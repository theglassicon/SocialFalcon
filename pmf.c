...
double LRATE1u  =            0.015;        // Learning rate parameter for features
...
double LRATE2ub =            0.015;        // Learning rate parameter for biases
...
//bias_reg=0.01 reg_u=0.015 reg_i=0.015
